...
###   Explanation:
      1. I created all roles as given in the question.  
      2. After that I created heirarchy just granting the role to other role as given in the question.  
...
###   Explanation:
      1.  I created the warehouse from ACCOUNTADMIN role.  
...
###   Explanation:-
                1. First will create the file format for parquet type.
...
###       Explanation:
             ...
             2. Here I have applied masking policy in three columns i.e., email, contact_no and ssn for both internal_employee and external_employee table
